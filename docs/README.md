...
| [neoforge-1.21.1-cats-integration.md](neoforge-1.21.1-cats-integration.md) | Why `neoforge-1.21.1` shades cats into a private namespace via shadow plugin instead of using SCF's bundled cats; JPMS module-layer traps |
